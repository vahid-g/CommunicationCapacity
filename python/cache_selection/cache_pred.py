...
def train_lr(df, size=0.33):
    df = df.fillna(0)
    #df = df.drop(['covered_term_t_full', 'bi_pop_4_c_full', 'bi_pop_4_t_full',
    #             'pop_2_c_full', 'bi_pop_2_c_full', 'bi_pop_2_t_full',
    #              'pop_1_c_full', 'bi_pop_3_t_full', 'bi_pop_3_c_full',
    #              'ql_t_full', 'bi_pop_1_t_full', 'bi_pop_1_c_full'], axis=1)
    labels = df['label']
