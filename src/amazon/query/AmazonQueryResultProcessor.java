...
public class AmazonQueryResultProcessor {
    ...
    public static void convertIsbnAnswersToLtidAndFilter(
	    QueryResult queryResult, Map<String, String> isbnToLtid) {
	...
	for (QueryResult.TopDocument doc : queryResult.getTopDocuments()) {
	    ...
	    QueryResult.TopDocument topDocument = queryResult.new TopDocument(
		    ltid, doc.title, doc.explanation);
