...
public class AmazonIsbnPopularityMap {
    ...
    private static final Logger LOGGER = Logger
	    .getLogger(AmazonIsbnPopularityMap.class.getName());
	...
	try {
		...
		String isbn = ids[0].substring(ids[0].lastIndexOf('/') + 1,
			ids[0].indexOf('.'));
	...
	LOGGER.log(Level.INFO,
		"Isbn -> Weight map size: " + isbnToWeight.size());
	return isbnToWeight;
    }

    public static void main(String[] args) {
	String w = AmazonIsbnPopularityMap.getInstance(
		"data/amazon/path_pop/amazon_path_reviews.csv").getWeight(
		"0446521000");
