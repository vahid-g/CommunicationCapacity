...
public class AmazonXmlUtils {
    ...
    private static final Logger LOGGER = Logger.getLogger(AmazonXmlUtils.class
	    .getName());

    public static String extractNodesTextFromXml(org.w3c.dom.Document xmlDoc,
	    AmazonDocumentField docField, Node bookNode) {
	...
	try {
	    ...
	    LOGGER.log(Level.WARNING, "Null Pointer: couldn't extract dewey "
		    + nodeName);
	}
	return nodeText;
    }
    ...
    public static String extractNormalizedTagNode(org.w3c.dom.Document xmlDoc,
	    String nodeName, Node bookNode) {
	String tags = "";
	try {
