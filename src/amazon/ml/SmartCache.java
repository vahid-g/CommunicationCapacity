...
public class SmartCache {
    ...
    private static final Logger LOGGER = Logger.getLogger(SmartCache.class
	    .getName());
	...
	try {
	    ...
	    features.add(getItemOrZero(xmlDoc.getElementsByTagName("listprice"))
		    .replace("$", "").replace(",", ""));
	    String date = getItemOrZero(xmlDoc
	    ...
	    features.add(dewey);
	    features.add(getItemOrZero(xmlDoc
		    .getElementsByTagName("numberofpages")));
	    features.add(Integer.toString(xmlDoc.getElementsByTagName("image")
		    .getLength()));
	    features.add(Integer.toString(xmlDoc.getElementsByTagName("review")
		    .getLength()));
	    features.add(Integer.toString(xmlDoc.getElementsByTagName(
		    "editorialreview").getLength()));
	    features.add(Integer.toString(xmlDoc
		    .getElementsByTagName("creator").getLength()));
	    features.add(Integer.toString(xmlDoc.getElementsByTagName(
		    "similarproduct").getLength()));
	    features.add(Integer.toString(xmlDoc.getElementsByTagName(
		    "browseNode").getLength()));
