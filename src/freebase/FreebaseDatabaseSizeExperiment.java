...
public class FreebaseDatabaseSizeExperiment {
	...
	static final String INDEX_BASE = DATA_FOLDER + "index/freebase_index/";
	...
	public static void main(String[] args) {
		...
		// databaseSizeStratified("tbl_all", threshold);
	}
	...
	public static void databaseSizeStratified(String tableName, double easeThreshold) {
		...
		try {
			fw_p3 = new FileWriter(FreebaseDatabaseSizeExperiment.RESULT_DIR + tableName + "_p3_stratified_hards_"
					+ easeThreshold + ".csv");
			fw_mrr = new FileWriter(FreebaseDatabaseSizeExperiment.RESULT_DIR + tableName + "_mrr_stratified_hards_"
					+ easeThreshold + ".csv");
