	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			String[] featureNames = { "query", "covered_t", "covered_c", "mean_df_t", "mean_df_c", "min_df_t",
					...
					"ql_c_bi", "qll_t_bi", "qll_c_bi", "scs_t", "scs_c", "maxSCQ_t", "maxSCQ_c", "maxVAR_t", "maxVAR_c"};
			...
			try (IndexReader indexReader = DirectoryReader.open(FSDirectory.open(indexPath));
				...
				for (ExperimentQuery query : queries) {
					...
					f.add(wqde.maxVar(indexReader, queryText, WikiFileIndexer.TITLE_ATTRIB, analyzer));
					f.add(wqde.maxVar(indexReader, queryText, WikiFileIndexer.CONTENT_ATTRIB, analyzer));
