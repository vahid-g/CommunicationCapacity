...
public class OnlinePopularityMiner {
	...
	public static void main(String[] args) {
		...
		Collection<File> allFiles = FileUtils.listFiles(new File(datasetPath), null, true);
	...
	public static void extractWikiCounts() {
		Collection<File> allFiles = FileUtils.listFiles(new File(ClusterDirectoryInfo.DATASET09_PATH), null, true);
	...
	private static String getHTML(String urlToRead) {
		...
		String newUrl = urlToRead.replaceAll("\\{.*\\}", "").replaceAll("%20", " ").trim().replaceAll(" ", "%20");
