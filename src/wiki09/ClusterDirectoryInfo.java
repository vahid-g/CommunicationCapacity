...
public class ClusterDirectoryInfo {
	...
	static final String MSN_QUERY_QID = CLUSTER_BASE
			+ "data/msn/query_qid.csv";
	static final String MSN_QID_QREL = CLUSTER_BASE
			+ "data/msn/qid_qrel.csv";
	static final String MSN_QUERY_QID_S = CLUSTER_BASE
			+ "data/msn/query_qid_small.csv";
	static final String MSN_QUERY_QID_B = CLUSTER_BASE
	...
	static final String INEX9_QUERY_FILE = CLUSTER_BASE
			+ "data/inex9_queries/queries.csv";
	static final String INEX9_QREL_FILE = CLUSTER_BASE
			+ "data/inex9_queries/queries.qrel";
	static final String INEX10_QUERY_FILE = CLUSTER_BASE
